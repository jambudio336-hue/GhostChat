    ...
    <ScreenContainer edges={["top", "left", "right", "bottom"]} containerClassName="bg-background">
      <View style={styles.screen}>
        ...
        <View style={styles.actionRow}>
          <Pressable style={styles.action} onPress={() => Alert.alert("Panggilan suara", "Memulai panggilan suara terenkripsi...")}><MaterialIcons name="call" size={19} color="#e7e9ed" /><Text style={styles.actionText}>SUARA</Text></Pressable>
          <Pressable style={styles.action} onPress={() => Alert.alert("Video call", "Memulai video call terenkripsi...")}><MaterialIcons name="videocam" size={19} color="#e7e9ed" /><Text style={styles.actionText}>VIDEO</Text></Pressable>
