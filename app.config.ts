...
const config: ExpoConfig = {
  ...
  newArchEnabled: true,
  ios: { supportsTablet: true, bundleIdentifier: "com.mrk1pl4y.ghostchat", infoPlist: { ITSAppUsesNonExemptEncryption: false } },
